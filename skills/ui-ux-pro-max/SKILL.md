---
name: ui-ux-pro-max
description: "UI/UX design intelligence expert for web and mobile applications. Use when designing interfaces, selecting color palettes, typography, visual styles, building landing pages, dashboards, or reviewing code for UX issues."
---
...
Consult the reference data below for:
...
| 2 | Touch and Interaction | CRITICAL - 44x44px touch targets, cursor-pointer |
| 3 | Performance | HIGH - Image optimization, lazy loading |
| 4 | Layout and Responsive | HIGH - Mobile-first, viewport meta |
| 5 | Typography and Color | MEDIUM - Line height 1.5-1.75, readable fonts |
...
| Dashboard | Corporate Tech | Flat Design, Data-Dense | Cool to Hot gradients + neutral |
...
| Part-to-Whole | Donut Chart | Percentages, proportions (5 or fewer items) |
...
### Focus States
Always visible focus ring: outline 2px solid #2563EB with 2px offset.
...
### Animations
- NO: Slow animations (over 500ms) or layout-shifting
